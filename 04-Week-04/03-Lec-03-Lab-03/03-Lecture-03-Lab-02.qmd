...
Let's use ` r labs() ` function to increase its readability.
...
ggplot(data = babies,
  ...
  theme_bw()
```
We added another layer called ` r theme_bw() `. This function is about the background, the size of the text etc.
