...
- Generally we obtain a single random sample, which comes from a very large population.
  ...
  - Then, we will address the scenario where no information about population parameters is available.
    - How can we, as life scientists, estimate population parameters (e.g., population mean, population proportion).
