...
- **RStudio** has four (for this week, it is three) main panes each in a quadrant of your screen
...
- enabling you to combine code and text to create rich outputs, like reports and presentations. _(like an advanced version of Word, Google Docs)_
...
::: {style="text-align: left; font-size: 36px"}

<br/><br/>

<span style="font-size: smaller;">We create an object by using "<-" called as "Object Assignment Operator"</span>
...
<div class="tenor-gif-embed" data-postid="15996460" data-share-method="host" data-aspect-ratio="1.33891" data-width="100%"><a href="https://tenor.com/view/roller-coaster-under-the-sea-we-spongebob-patrick-gif-15996460">Roller Coaster Under The Sea GIF</a>from <a href="https://tenor.com/search/roller+coaster-gifs">Roller Coaster GIFs</a></div> <script type="text/javascript" async src="https://tenor.com/embed.js"></script>
