...
- Quarto is a document format that combines text and code
...
- We will use Quarto to produce (render!) PDF documents for our lab assignments, take-home midterms, and final exams where we integrate both text and code.
<br>
