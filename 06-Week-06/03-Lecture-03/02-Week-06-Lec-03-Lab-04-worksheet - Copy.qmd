...
__Question 4. Use a one sample $t$-test to investigate whether the bill length of the penguins differs from the test value of 40 mm. Use the 5% significance level ($\alpha = 0.05$).__
...
__Question 4.3. Calculate t statistic by running the code chuck below and explain what you see in the output.__
...
__Question 4. Use an independent samples $t$-test to investigate whether the body mass of penguins differs between different sexes. Use the 10% significance level ($\alpha = 0.10$).__


__Question 4.1 Write out the null & the alternative hypothesis in words, in the context of this study:__
...
__Question 4.4. Explain what each function does in this question.__
...
__Question 4.3. Calculate test statistic by running the code chuck below and explain what you see in the output.__
